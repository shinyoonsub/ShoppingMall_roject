...
<body>
		...
		<div class="goods_table_wrap">
			...
			<c:if test="${listcheck != 'empty'}">
				<table class="goods_table">
					...
					<tr>
						<td><c:out value="${list.vinId}"></c:out></td>
						<td>
							<a class="move" href='<c:out value="${list.vinId}"/>'>
								<c:out value="${list.vinName}"></c:out>
							</a>
						</td>
						<td><c:out value="${list.cateName}"></c:out></td>
						<td><c:out value="${list.vinStock}"></c:out></td>
	...
	$(".move").on("click", function(e){
		...
		moveForm.append("<input type='hidden' name='vinId' value='"+$(this).attr("href") + "'>");
