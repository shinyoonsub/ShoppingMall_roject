...
<link rel="stylesheet" href="../resources/css/menu/bottom.css">
<script
	...
	<div class="wrap">
		...
		<div class="footer_bottom">
			<div class="footer_copy">
				...
				<br>
				CALL : 010-1234-1234 / E-MAIL : pec6049@naver.com / BUSINESS LICENSE : 123-45-67890
				<br>
				COPYRIGHT © vanstore ALL RIGHTS RESERVED.
			</div>
			<div class="clearfix"></div>
		</div>
	</div>	<!-- class="wrap" -->
